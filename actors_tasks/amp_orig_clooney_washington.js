define(['pipAPI', 'https://navmayan.github.io/implicit_tasks_qltrcs/AMP_actors_parameters_original.js'], function(APIConstructor, ampExtension){
//Adapted from Bengayev, E. (2020, July 27). Running Project Implicit’s AMP from Qualtrics [Blog post]. Retrieved from https://minnojs.github.io/minnojs-blog/qualtrics-amp/  
	...
	return ampExtension({
		...
		primeCats :  [
			...
			{
				nameForFeedback : 'Denzel Washington',  //Will be used in the user feedback 
				nameForLogging : 'denzel_washington', //Will be used in the logging
				//An array of all media objects for this category.
				mediaArray : [
				    {image : 'Denzel Washington1.jpg'}, 
					{image : 'Denzel Washington2.jpg'}, 
					{image : 'Denzel Washington3.jpg'}, 
					{image : 'Denzel Washington4.jpg'}, 
					{image : 'Denzel Washington5.jpg'}]
			}
		],
